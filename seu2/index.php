          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a data-toggle="modal" data-target=""><span class="glyphicon glyphicon-pencil" aria-hidden="true" ></span> &nbsp;修改密码</a></li>
                  <li><a href="./index.html"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> &nbsp;个人信息</a></li>
                  <li role="separator" class="divider"></li>
                  <li><a><span class="glyphicon glyphicon-off" aria-hidden="true"></span> &nbsp;注销帐号</a></li>
                </ul>
              </li>
            </ul>
          </div><!-- /.navbar-collapse -->
                              ...
                              <form>
                                <div class="form-group" style="height: 59px;">
                                  <div class="pull-left">
                                    ...
                                    <input type="text" class="form-control" placeholder="yyyy-mm-dd" aria-describedby="sizing-addon1" id="add_data_tech_kind">
                                  </div>
                                  <div class="" style="width: 172px;display: inline-block;margin-left: 25px;">
                                    ...
                                    <select type="button" class="btn btn-default dropdown-toggle btn-lg course-term" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="width: 172px;height: 34px;border-radius: 4px;font-size: 14px;" id="add_data_tech_kind">
                                      <option><a href="#" value=1>校级SRTP</a></option>
                                      <option><a href="#" value=2>省创</a></option>
                                      <option><a href="#" value=3>国创</a></option>
                                      <option><a href="#" value=4>挑战杯</a></option>
                                      <option><a href="#" value=5>课外研学讲座</a></option>
                                      <option><a href="#" value=6>其他</a></option>
                                    </select>
                                  </div>
                              ...
                              <form>
                                <div class="form-group" style="height: 59px;">
                                  <div class="pull-left">
                                    ...
                                    <input type="text" class="form-control" placeholder="yyyy-mm-dd" aria-describedby="sizing-addon1" id="add_data_prac_data">
                                  </div>
                                  <div class="" style="width: 172px;display: inline-block;margin-left: 25px;">
                                    <label for="message-text" class="control-label">类别:</label>
                                    <select type="button" class="btn btn-default dropdown-toggle btn-lg course-term" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="width: 172px;height: 34px;border-radius: 4px;font-size: 14px;" id="add_data_prac_kind">
                                      <option><a href="#" value=1>志愿者活动</a></option>
                                      <option><a href="#" value=2>学生会工作</a></option>
                                      <option><a href="#" value=3>社团工作</a></option>
                                    </select>
                                  </div>
                                  <div class="pull-right">
                                    <label for="message-text" class="control-label">评分:</label>
                              ...
                              <div class="modal-body">
                                <form>
                                  <div class="form-group" style="height: 59px;">
                                    <div class="pull-left">
                                      <label for="message-text" class="control-label">日期:</label>
                                      <input type="text" class="form-control" placeholder="yyyy-mm-dd" aria-describedby="sizing-addon1">
                                    </div>
                                    <div class="" style="width: 172px;display: inline-block;margin-left: 25px;">
                                      <label for="message-text" class="control-label">类别:</label>
                                      <select type="button" class="btn btn-default dropdown-toggle btn-lg course-term" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="width: 172px;height: 34px;border-radius: 4px;font-size: 14px;">
                                        <option><a href="#">志愿者活动</a></option>
                                        <option><a href="#">学生会工作</a></option>
                                        <option><a href="#">社团工作</a></option>
                                      </select>
                                    </div>
                                    <div class="pull-right">
                                      <label for="message-text" class="control-label">评分:</label>
                                      <input type="text" class="form-control" placeholder="百分制" aria-describedby="sizing-addon1">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label for="recipient-name" class="control-label">地点:</label>
